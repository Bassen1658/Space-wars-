...
#Hämtar bilderna på rymdskäppen
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join("Assets", "spaceship_yellow.png"))
#Ändrar storlerk och roterar
...
def main():
    ...
    #clock kontrollerar FPSen kopplat till hårda variablen FPS 
...
#Hindrar spelet från att köras automatiskt om den importeras från en annan fil
